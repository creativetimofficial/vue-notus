          ...
          >
            <div class="px-6">
              ...
              <div class="text-center mt-12">
                ...
                >
                  <i
                    class="fas fa-map-marker-alt mr-2 text-lg text-coolGray-400"
                  ></i>
                  Los Angeles, California
                </div>
                <div class="mb-2 text-coolGray-600 mt-10">
                  <i
                    class="fas fa-briefcase mr-2 text-lg text-coolGray-400"
                  ></i>
                  Solution Manager - Creative Tim Officer
                </div>
                <div class="mb-2 text-coolGray-600">
                  <i
                    class="fas fa-university mr-2 text-lg text-coolGray-400"
                  ></i>
